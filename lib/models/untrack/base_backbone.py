...
class BaseBackbone(nn.Module):
    def __init__(self):
        ...
        # for original ViT
        self.pos_embed = None   # 原始 ViT 的位置编码（用于 224x224 图像）
        ...
        self.pos_embed_z = None     # 模板的位置编码
        self.pos_embed_x = None     # 搜索区域的位置编码
        ...
        self.add_sep_seg = False    # 是否添加 模态/区域区分的segment embedding (分段嵌入)
